...
//Variavel global
int quantidade_de_acionamento = 0;
...
void loop()
{
  ...
  if(digitalRead(ENTRADA_1) == LIGADO){
   quantidade_de_acionamento = quantidade_de_acionamento + 1;
    if(quantidade_de_acionamento > 7){
      quantidade_de_acionamento = 0;
    }
   delay(500);
  }
  
  if(quantidade_de_acionamento == 0){
  ...
  } else if(quantidade_de_acionamento == 1) {
    digitalWrite(LED_1, DESLIGADO);
    digitalWrite(LED_2, LIGADO);
    digitalWrite(LED_3, DESLIGADO);
    digitalWrite(LED_4, LIGADO);
    digitalWrite(LED_5, DESLIGADO);
  } else if(quantidade_de_acionamento == 2) {
    digitalWrite(LED_1, LIGADO);
    digitalWrite(LED_2, DESLIGADO);
    digitalWrite(LED_3, LIGADO);
    digitalWrite(LED_4, DESLIGADO);
    digitalWrite(LED_5, LIGADO);
  } else if(quantidade_de_acionamento == 3) {
    digitalWrite(LED_1, DESLIGADO);
    digitalWrite(LED_2, DESLIGADO);
    digitalWrite(LED_3, DESLIGADO);
    digitalWrite(LED_4, DESLIGADO);
    digitalWrite(LED_5, LIGADO);
  } else if(quantidade_de_acionamento == 4) {
    digitalWrite(LED_1, DESLIGADO);
    digitalWrite(LED_2, DESLIGADO);
    digitalWrite(LED_3, DESLIGADO);
    digitalWrite(LED_4, LIGADO);
    digitalWrite(LED_5, LIGADO);
  } else if(quantidade_de_acionamento == 5) {
    digitalWrite(LED_1, DESLIGADO);
    digitalWrite(LED_2, DESLIGADO);
    digitalWrite(LED_3, LIGADO);
    digitalWrite(LED_4, LIGADO);
    digitalWrite(LED_5, LIGADO);
  } else if(quantidade_de_acionamento == 6) {
    digitalWrite(LED_1, DESLIGADO);
    digitalWrite(LED_2, LIGADO);
    digitalWrite(LED_3, LIGADO);
    digitalWrite(LED_4, LIGADO);
    digitalWrite(LED_5, LIGADO);
  } else if(quantidade_de_acionamento == 7) {
    digitalWrite(LED_1, LIGADO);
    digitalWrite(LED_2, LIGADO);
    digitalWrite(LED_3, LIGADO);
    digitalWrite(LED_4, LIGADO);
